...
async function seedProducts() {
  ...
  if (count === 0) {
    const sampleProducts = [
      ...
      { name: 'Premium Espresso Machine', description: '15-bar pump espresso machine with milk frother. Brews cafe-quality coffee at home.', price: 449.99, originalPrice: 599.99, images: ['https://images.unsplash.com/photo-1517246286438-e6b360fbf365?w=500'], category: 'Home & Living', size: ['One Size'], color: ['Stainless Steel'], brand: 'BakeElite', availability: true, stock: 15, rating: 4.9, reviewCount: 120, deliveryDays: 4, tags: ['coffee', 'espresso', 'kitchen', 'appliance'], featured: true },
      { name: 'Ergonomic Office Chair', description: 'High-back mesh ergonomic office chair with adjustable lumbar support and 3D armrests.', price: 259.99, originalPrice: 349.99, images: ['https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?w=500'], category: 'Home & Living', size: ['One Size'], color: ['Black', 'Gray'], brand: 'ErgoSit', availability: true, stock: 40, rating: 4.6, reviewCount: 310, deliveryDays: 5, tags: ['chair', 'office', 'ergonomic', 'furniture'], featured: true },
      { name: 'Smartphone Gimbal Stabilizer', description: '3-axis handheld gimbal stabilizer for smartphones. Includes object tracking and timelapse mode.', price: 119.99, originalPrice: 149.99, images: ['https://images.unsplash.com/photo-1574880004907-8e68449c2889?w=500'], category: 'Electronics', size: ['One Size'], color: ['Black'], brand: 'SmoothCams', availability: true, stock: 65, rating: 4.5, reviewCount: 88, deliveryDays: 3, tags: ['gimbal', 'camera', 'smartphone', 'photography'], featured: false },
      { name: 'High-Fidelity Turntable', description: 'Belt-drive turntable with premium diamond stylus and built-in phono preamp for analog audio perfection.', price: 349.99, originalPrice: 429.99, images: ['https://images.unsplash.com/photo-1510461876527-31ba5116de04?w=500'], category: 'Electronics', size: ['One Size'], color: ['Walnut', 'Black'], brand: 'AudioClassic', availability: true, stock: 25, rating: 4.7, reviewCount: 145, deliveryDays: 4, tags: ['turntable', 'vinyl', 'audio', 'music'], featured: true },
      { name: 'Organic Matcha Green Tea', description: 'Ceremonial grade organic matcha powder from Uji, Japan. Rich in antioxidants.', price: 29.99, originalPrice: 39.99, images: ['https://images.unsplash.com/photo-1582793988951-9aed5509eb97?w=500'], category: 'Food & Beverages', size: ['30g', '100g'], color: [], brand: 'ZenTea', availability: true, stock: 150, rating: 4.8, reviewCount: 520, deliveryDays: 2, tags: ['matcha', 'tea', 'organic', 'beverages'], featured: false },
      { name: 'Men\'s Chronograph Watch', description: 'Elegant stainless steel chronograph watch with sapphire crystal and waterproof up to 50m.', price: 189.99, originalPrice: 249.99, images: ['https://images.unsplash.com/photo-1524592094714-e054ba520261?w=500'], category: 'Accessories', size: ['One Size'], color: ['Silver/Blue', 'Black/Black', 'Gold/White'], brand: 'ChronoTime', availability: true, stock: 60, rating: 4.6, reviewCount: 215, deliveryDays: 3, tags: ['watch', 'mens', 'jewelry', 'chronograph'], featured: true }
    ];
